...
export const FIFA_CLUBS: Club[] = [
  ...
  { id: 'brighton', name: 'Brighton', stars: 4, league: 'Premier League' },
  ...
  { id: 'getafe', name: 'Getafe', stars: 3.5, league: 'La Liga' },
  ...
  { id: 'werder-bremen', name: 'Werder Bremen', stars: 3.5, league: 'Bundesliga' },
  ...
  { id: 'braga', name: 'SC Braga', stars: 4, league: 'Portugal' },
