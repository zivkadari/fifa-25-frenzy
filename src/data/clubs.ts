...
export const FIFA_CLUBS: Club[] = [
  ...
  { id: 'barcelona', name: 'FC Barcelona', stars: 4.5, league: 'La Liga' },
  { id: 'liverpool', name: 'Liverpool', stars: 4.5, league: 'Premier League' },
  { id: 'bayern-munich', name: 'FC Bayern München', stars: 4.5, league: 'Bundesliga' },
  { id: 'inter', name: 'Inter', stars: 4.5, league: 'Serie A' },
  ...
  { id: 'atletico-madrid', name: 'Atlético Madrid', stars: 4, league: 'La Liga' },
  { id: 'newcastle', name: 'Newcastle United', stars: 4, league: 'Premier League' },
  { id: 'ac-milan', name: 'AC Milan', stars: 4, league: 'Serie A' },
  { id: 'borussia-dortmund', name: 'Borussia Dortmund', stars: 4, league: 'Bundesliga' },
  { id: 'tottenham', name: 'Tottenham Hotspur', stars: 4, league: 'Premier League' },
  { id: 'manchester-united', name: 'Manchester United', stars: 4, league: 'Premier League' },
  { id: 'chelsea', name: 'Chelsea', stars: 4, league: 'Premier League' },
  
  // National Teams (5-star)
  { id: 'france', name: 'France', stars: 4.5, league: 'National Teams', isNational: true },
  ...
  { id: 'marseille', name: 'Olympique de Marseille', stars: 3.5, league: 'Ligue 1' },
  { id: 'west-ham', name: 'West Ham United', stars: 3.5, league: 'Premier League' },
  { id: 'crystal-palace', name: 'Crystal Palace', stars: 3.5, league: 'Premier League' },
  { id: 'nottingham-forest', name: 'Nottingham Forest', stars: 3.5, league: 'Premier League' },
  { id: 'brighton', name: 'Brighton & Hove Albion', stars: 3.5, league: 'Premier League' },
  { id: 'bournemouth', name: 'AFC Bournemouth', stars: 3.5, league: 'Premier League' },
  { id: 'lyon', name: 'Olympique Lyonnais', stars: 3.5, league: 'Ligue 1' },
  ...
  { id: 'como', name: 'Como', stars: 3, league: 'Serie A' },
  ...
  { id: 'leicester', name: 'Leicester City', stars: 3.5, league: 'Premier League' },
