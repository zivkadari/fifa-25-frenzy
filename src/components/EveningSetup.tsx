        ...
        <div className="space-y-3">
          ...
          <Card className="bg-gaming-surface/50 border-border/50 p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-base font-semibold text-foreground">בחר קבוצה (אופציונלי)</h2>
            </div>
            {teams.length ? (
              <>
          ...
          <Card className="bg-gradient-card border-neon-green/20 p-3 shadow-card">
            <div className="flex items-center gap-2 mb-2">
              <Users className="h-4 w-4 text-neon-green" />
              <h2 className="text-base font-semibold text-foreground">Player Names</h2>
            </div>
            <div className="space-y-2">
              <div className="grid grid-cols-2 gap-2">
                {playerNames.map((name, index) => (
                  <div key={index} className="relative h-10 rounded-md border border-border bg-gaming-surface flex items-center justify-center px-2">
                    {name ? (
                      <>
                      ...
                      <span className="text-muted-foreground text-xs">Player {index + 1}</span>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="bg-gaming-surface border-border h-8 text-sm"
                />
                <Input
                  ...
                  className="bg-gaming-surface border-border h-8 text-sm"
                />
                <Button variant="outline" size="sm" onClick={addNewPlayerToList} className="h-8 px-2">
                  +
                </Button>
              </div>
          ...
          {/* Wins to Complete Round - Inline compact */}
          <Card className="bg-gradient-card border-neon-green/20 p-3 shadow-card">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Trophy className="h-4 w-4 text-neon-green" />
                <span className="text-sm font-medium text-foreground">Wins to win round</span>
              </div>
              <div className="flex items-center gap-2">
                <Button 
                  variant="outline" 
                ...
                <span className="text-lg font-bold text-neon-green w-6 text-center">
                  {winsToComplete}
                </span>
                <Button 
                  variant="outline" 
